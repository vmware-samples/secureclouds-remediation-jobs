...
class EC2ClosePort23(object):
    ...
    def remediate(self, client, instance_id):
        """Block public access to port 23 of all security groups attached to an EC2 instance
        by removing all the rules with port 23 in the port range
            ...
            for sg_info in security_groups:
                ...
                for rule in security_group_rules["SecurityGroupRules"]:
                    if (
                        ...
                        # Removes Ingress security group rule containing port 23 in the range with
