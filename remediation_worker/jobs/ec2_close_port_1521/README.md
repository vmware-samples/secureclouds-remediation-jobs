# Close Port 1521 for all Security Groups associated with an EC2 Instance

This job blocks public access to port 1521 for both IPv4 and IPv6 for all security groups associated with an EC2 instance by removing all the ingress security group rules containing port 1521 in the port range and source as "0.0.0.0/0" or "::/0".

### Applicable Rule

##### Rule ID:
5c8c26417a550e1fb6560c3e
...
```shell script
  ...
  python3 ec2_close_port_1521.py
```
