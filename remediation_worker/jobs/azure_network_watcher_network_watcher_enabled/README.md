...
This job enables the Network Watcher for all the regions in the Azure subscription.

### Applicable Rule

##### Rule ID:
5c8c26747a550e1fb6560c8d
...
```shell script
  ...
  python3 azure_network_watcher_network_watcher_enabled.py
```
## Running the tests
