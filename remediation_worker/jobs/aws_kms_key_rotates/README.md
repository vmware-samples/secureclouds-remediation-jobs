...
##### Rule ID:
5c8c26217a550e1fb6560c12

##### Rule Name:
KMS automated key rotation is not enabled

## Getting Started

### Prerequisites

The provided AWS credential must have access to `kms:EnableKeyRotation`.
...
```shell script
  ...
  python3 aws_kms_key_rotates.py
```
