# Close Port 5439 for all Security Groups associated with an EC2 Instance

This job blocks public access to port 5439 for both IPv4 and IPv6 for all security groups associated with an EC2 instance.
