# Close Port 3306 for all Security Groups associated with an EC2 Instance

This job blocks public access to port 3306 for both IPv4 and IPv6 for all security groups associated with an EC2 instance by removing all the ingress security group rules containing port 3306 in the port range and source as "0.0.0.0/0" or "::/0".

### Applicable Rule

##### Rule ID:
5c8c26427a550e1fb6560c41
...
```shell script
  ...
  python3 ec2_close_port_3306.py
```
