...
class EC2ClosePort3306(object):
    ...
    def remediate(self, client, instance_id):
        """Block public access to port 3306 of all security groups attached to an EC2 instance
        by removing all the rules with port 3306 in the port range
            ...
            for sg_info in security_groups:
                ...
                for rule in security_group_rules["SecurityGroupRules"]:
                    if (
                        ...
                        # Removes Ingress security group rule containing port 3306 in the range with
