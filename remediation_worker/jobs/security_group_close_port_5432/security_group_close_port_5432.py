...
class SecurityGroupClosePort5432(object):
    ...
    def remediate(self, client, security_group_id):
        """Block public access to port 5432 for both IPv4 and IPv6 by
        removing all the rules containing port 5432 in the range.
        ...
        try:
            ...
            for rule in security_group_rules["SecurityGroupRules"]:
                if (
                    ...
                    # Removes Ingress security group rule containing port 5432 in the range with
