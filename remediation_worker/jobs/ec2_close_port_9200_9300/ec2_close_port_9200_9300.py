...
class EC2ClosePort9200_9300(object):
    ...
    def remediate(self, client, instance_id):
        """Block public access to port 9200 and 9300 of all security groups attached to an EC2 instance
        by removing all the rules with port 9200 and 9300 in the port range
                ...
                for port in ports:
                    ...
                    for rule in security_group_rules["SecurityGroupRules"]:
                        if (
                            ...
                            # Removes Ingress security group rule containing port 27017 in the range with
