...
This job enables SQL Database Server threat detection.

### Applicable Rule

##### Rule ID:
5c8c26947a550e1fb6560cce

##### Rule Name:
SQL server threat detection is not enabled
...
```shell script
  ...
  python3 azure_sql_threat_detection_on_server.py
```
## Running the tests
