...
This job blocks public access to port 27017 for both IPv4 and IPv6 for all security groups associated with an EC2 instance by removing all the ingress security group rules containing port 27017 in the port range and source as "0.0.0.0/0" or "::/0".
