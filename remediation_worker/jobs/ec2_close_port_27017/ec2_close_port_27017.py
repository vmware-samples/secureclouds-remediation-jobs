...
class EC2ClosePort27017(object):
    ...
    def remediate(self, client, instance_id):
        """Block public access to port 27017 of all security groups attached to an EC2 instance
        by removing all the rules with port 27017 in the port range
