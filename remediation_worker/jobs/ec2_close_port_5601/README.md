# Close Port 5601 for all Security Groups associated with an EC2 Instance

This job blocks public access to port 5601 for both IPv4 and IPv6 for all security groups associated with an EC2 instance.
