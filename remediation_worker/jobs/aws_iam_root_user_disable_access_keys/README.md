# Making Root user access keys inactive

This job makes root user access keys inactive.

### Applicable Rule

##### Rule ID:
5c8c26137a550e1fb6560c01
...
The provided AWS credential must have access to `iam:ListAccessKeys` and `iam:UpdateAccessKey`.
...
```shell script
  ...
  python3 aws_iam_root_user_disable_access_keys.py
```
