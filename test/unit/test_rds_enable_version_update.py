...
from remediation_worker.jobs.rds_enable_version_update.rds_enable_version_update import RDSUpgradMinorVersion 
...
class TestRDSUpgradMinorVersion:
    def test_parse_payload(self, valid_payload):
        obj = RDSUpgradMinorVersion()
        param = obj.parse(valid_payload)
        assert "database_id" in param
        assert param["database_id"] == "i-00347a2be30cf1a15"
