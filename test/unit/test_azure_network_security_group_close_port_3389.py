...
from remediation_worker.jobs.azure_network_security_group_close_port_3389.azure_network_security_group_close_port_3389 \
    import (
    NetworkSecurityGroupClosePort3389,
)
...
class TestNetworkSecurityGroupClosePort22(object):
    def test_parse_payload(self, valid_payload1):
        params = NetworkSecurityGroupClosePort3389().parse(valid_payload1)
